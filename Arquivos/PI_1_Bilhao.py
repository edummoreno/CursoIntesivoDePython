...
mp.dps = 1000000000 #O mpmath permite definir a precisão em 'dps' (dígitos de precisão).O mpmath permite definir a precisão em 'dps' (dígitos de precisão).
...
with open('pi_bilhao_decimais.txt','w') as file:
